...
const { SCHEMA, SCHEMA_FIELD, } = require('ilorm-constants');
...
class BaseSchema {
  ...
  constructor(schemaDefinition, options = {}) {
    ...
    this.properties.forEach(property => {
      this.definition[property][SCHEMA_FIELD.NAME] = property;

      if (this.definition[property][SCHEMA_FIELD.IS_PRIMARY]) {
   ...
   * @returns {SchemaField[]} An array of schema field
   */
  getPrimaryKeys() {
